...
export default function CreateVenue() {
  ...
  async function handleSubmit(e) {
    ...
    if (result.data?.id) {
      ...
      setMessage(result.errors?.[0]?.message || "Could not create venue.");
    }
  }
      ...
      <section className="max-w-6xl mx-auto px-6 py-10">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">
            Add a new accommodation to Holidaze.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[1.3fr_0.9fr] gap-8 items-start">
          ...
          <aside className="bg-white rounded-3xl shadow-sm p-6 sticky top-8">
            ...
            <p className="text-gray-500 mt-1 line-clamp-3">
              {formData.description || "Your venue description will appear here."}
            </p>
